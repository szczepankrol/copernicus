...
function media_upload_single(filetype, field_id, title, button) {
	media_upload(filetype, field_id, title, button, false);
}

function media_upload_multiple(filetype, field_id, title, button) {
	media_upload(filetype, field_id, title, button, true);
}

function media_upload(filetype, field_id, title, button, multiple) {
